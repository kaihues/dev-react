...
export default function App() {
  ...
  return (
    <div class = "FullApp">
      ...
      <ul class = "CatList">
        <li><Cat imgSrc1={ CatOneF1 } imgSrc2 = { CatOneF2 } audioSrc = { catSong1 } text = { text1 } /></li>
        <li><Cat imgSrc1={ CatTwoF1 } imgSrc2 = { CatTwoF2 } audioSrc = { catSong2 } text = { text2 } /></li>
        <li><Cat imgSrc1={ CatThreeF1 } imgSrc2 = { CatThreeF2 } audioSrc = { catSong3 } text = { text3 } /></li>
        <li><Cat imgSrc1={ CatFourF1 } imgSrc2 = { CatFourF2 } audioSrc = { catSong4 } text = { text4 } /></li>
